...
--------------------------------------
create table person(
    per_id number generated by default on null as identity,
...
create table company(
    comp_id number generated by default on null as identity,
...
-- PERSON --
Insert into PERSON (PER_NAME,APT_NUMBER,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,EMAIL,GENDER) values ('Carlin Bremer',null,1803,'Broad Brook Crest','Metairie','LA',70001,'carbre@gmail.com','male');
Insert into PERSON (PER_NAME,APT_NUMBER,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,EMAIL,GENDER) values ('Sir Prancelot Brainfire',null,666,'Everend Drive','Kenner','LA',70065,'prace_a_lot@aol.com','male');
Insert into PERSON (PER_NAME,APT_NUMBER,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,EMAIL,GENDER) values ('Janak Tucci',null,6734,'Green Rise Grounds','New Orleans','LA',70115,'ja.tucci@gmail.com','female');
Insert into PERSON (PER_NAME,APT_NUMBER,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,EMAIL,GENDER) values ('Sylvia Boler',null,1519,'Cinder Concession','New Orleans','LA',70122,'deep_lover69@gmail.com','female');
Insert into PERSON (PER_NAME,APT_NUMBER,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,EMAIL,GENDER) values ('Robert Christmas','2B',648,'Fire Circle','Gretna','LA',70053,'wingmanPro@yahoo.net','male');
...
-- COMPANY --
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Two Sisters',236,'Weird Way','New Orleans','LA',70112,'oil and mining','twosisters.com');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('The Diaper Exchange',246,'Poop Street','New Orleans','LA',70115,'entertainment','poophere.org');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Brandon, Inc.',24,'Brandon Drive','Brandon','LA',70178,'entertainment','brandon.com');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('The Bradon Bros.',727,'Brandon Avenue','Brandon','LA',70178,'education','brandons.net');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Panda Expressions',5278,'Silly Banana Circle','Metairie','LA',70001,'entertainment','smellthatish.com');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Dungeons and Magazines',11536,'Dancing Way','New Orleans','LA',70122,'computer hardware','rollmag.io');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Help Save Me Co.',587,'This Place','Kenner','LA',70065,'life services','helpsave.me');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Computer Co.',37,'1001011 Avenue','New Orleans','LA',70118,'computer hardware','computer.co');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Gooble',458,'Broadway','New Orleans','LA',70112,'big data','gooble.com');
Insert into COMPANY (COMP_NAME,STREET_NUMBER,STREET_NAME,CITY,STATE,ZIP_CODE,PRIMARY_SECTOR,WEBSITE) values ('Facebonk',62,'Main Street','Gretna','LA',70053,'social network','facebonk.com');
